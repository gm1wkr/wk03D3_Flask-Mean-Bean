...
bean_2 = Bean("WhervU Bean", "Elusive, green and goes unseen.  Have you seen my wayward bean?", "12/12/2022", 10.00, True, True)
bean_3 = Bean("Soya Bean", "A stolewart for recipes that require soya beans, no other bean will do.", "12/12/2022", 10.00, False, False)
bean_4 = Bean("Blackeye Bean", "A fiesty little bean who is not afraid to throw a punch at a scabby horse, yes, he got kicked!", "12/12/2022", 10.00, True, False)
